...
| Setting | Value |
|---------|-------|
| Primary | `http://browser.lan:8000` |
| Health Check | `curl -s http://browser.lan:8000/health` |
| Fallback | DevTools take_screenshot (size-limited) |
| Max Page Height | 4000px (DevTools fallback threshold) |
| Human Intervention Path (Local) | `/Volumes/Development/screenshots/` |
| Human Intervention Path (Remote) | `/mnt/development/screenshots/` |

**Fallback Chain:**
1. Primary: Chromium Screenshots API (browser.lan)
2. Fallback: DevTools take_screenshot (only if page < 4000px height)
3. Last Resort: Request human intervention, pause execution

---

## Visual/Audit Mode Settings

| Setting | Value |
|---------|-------|
| Evidence Retention (quick) | None |
| Evidence Retention (visual) | Failures only |
| Evidence Retention (audit) | All screenshots |
| Audit Evaluation Template | `.planning/.templates/testing/audit-evaluation.md` |
| TD Auto-Log | true |
| TD Scope Annotation | true |

**Effort Thresholds for TD Classification:**
| Effort | Destination | Description |
|--------|-------------|-------------|
| <2 hours | README.md (Quick Fixes) | Log with scope, act immediately if possible |
| 2-8 hours | README.md (Requires Planning) | Needs research, multiple touchpoints |
| >8 hours | `td-##-topic.md` | Full planning lifecycle required |
