...
Version-free Anthropic aliases from `quickstart`, so Claude Code setups survive the daily model catalog refresh. Docs updated to match the current Synthetic and Alibaba catalogs.
